...
AP.ITEM_IMPLS = {
    ...
    [78773] = function(ap)
        ...
        Game():StartRoomTransition(level:GetRandomRoomIndex(true, ap.RNG:Next()),-1, RoomTransitionAnim.TELEPORT)
    end,
    [78774] = function(ap)
            ...
            if self.IS_CONTINUED then
                if self.MOD_REF:HasData() then
                    ...
                    if modData ~= nil and modData.SAVED_SEED ~= nil and modData.SAVED_ITEM_INDEX ~= nil and
                        ...
                        modData.HAD_STEAM_SALE ~= nil and self.CONNECTION_INFO.slot_data["seed"] == modData.SAVED_SEED then
...
MOD_INSTANCE_AP = AP(HOST_ADDRESS, HOST_PORT, SLOT_NAME, PASSWORD or "")
